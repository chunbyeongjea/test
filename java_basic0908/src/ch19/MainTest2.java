...
//		books.add(book5);
//		
//		books = removeLastIndex(books);
//		
//		System.out.println(books);

		// 문제 : 현재 생성된 arraylist에 마지막 인덱스만을 삭제하는 함수를 완성해 주세요
	} // end of main
		// 넘겨 받은 arraylist에 마지막 인덱스 값을 삭제하는 함수

	public static ArrayList<Book> removeLastIndex(ArrayList<Book> list) {
		// tip 매개변수로 통해 들어온 데이터는 지역변수를 선언해서 초기화 해주는게 좋다
